...
const checkMarkdownOptions = (options = {}) => {
    ...
    if ("externalLinks" in options) {
        logger.error('"markdown.externalLinks" is no longger supported in VuePress2, please use "markdown.links.externalAttrs" instead.');
        delete options["externalLinks"];
    }
    // plugins
    if ("plugins" in options) {
        logger.error('"markdown.plugins" is no longger supported in VuePress2, please use "extendsMarkdown" hook instead.');
